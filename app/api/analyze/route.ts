...
- knowledgeAid содержит только компактную справку по теме, а не ответы к самому заданию. Для соответствий используй table (до 3 колонок и 8 строк), для набора фактов — list, для образцов — examples.
